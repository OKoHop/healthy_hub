import{s as i,u,a as f,r as p,f as Z,j as e,c as O,g as H,N as tt,M as V,b as et,d as v,e as it,_,P as b,h as nt,i as W,L as J}from"./index-9a561cf5.js";import{C as $,A as S,p as D,a as C,D as z}from"./index-99a8a8ad.js";import{s as ot}from"./Buttons.styled-d154cf06.js";import{R as st,t as j,s as rt,b as at,c as k,l as dt,d as lt,a as ct}from"./calculateTotalIngridients-57c612a4.js";import{g as pt,r as xt,R as ht}from"./randomizeFood-b5aad31b.js";const mt=i.div`
  border-radius: 12px;
...
`,E=i.span`
  color: #b6b6b6;
`;$.register(S,D,C);const Gt=()=>{const t=f(vt)||0,s=f(Dt)||0,r=(o,n)=>o-n,d=(o,n)=>isNaN(Math.round(n/o*100))?0:Math.round(n/o*100),a=o=>100-o,x={datasets:[{data:[d(t,s),a(d(t,s))],backgroundColor:["#FFF3B7","#292928"],borderWidth:0,borderRadius:14,circumference:360,cutout:"80%"}]},h={id:"textCenter",beforeDatasetsDraw(o){const{ctx:n,data:m}=o,l=o.getDatasetMeta(0).data[0].x,c=o.getDatasetMeta(0).data[0].y,g=m.datasets[0].data[0];n.save(),n.font="400 14px sans-serif",n.fillStyle="#B6B6B6",n.textAlign="center",n.textBaseline="middle",n.fillText(`${g}%`,l,c)}};return e.jsxs(Tt,{children:[e.jsx(z,{data:x,plugins:[h]}),e.jsxs(Pt,{children:[e.jsx(Et,{children:"Fat"}),e.jsxs(Nt,{children:[e.jsxs(N,{children:["Goal: ",e.jsx(E,{children:t})]}),e.jsxs(N,{children:["left: ",e.jsx(E,{children:r(t,s)})]})]})]})]})},At=i.div`
  background-color: #0f0f0f;
  border-radius: 12px;
  display: flex;
  flex-direction: column;
...
`;V.setAppElement("#root");const $e=({open:t,close:s})=>{const r=u(),d=a=>{a.preventDefault();const h=a.currentTarget.elements.water.value;r(et(h)),r(v()),s()};return e.jsxs(ke,{isOpen:t,onRequestClose:s,contentLabel:"Example Modal",overlayClassName:"Overlay",children:[e.jsx(ue,{children:"Add water intake"}),e.jsxs("div",{children:[e.jsxs(be,{onSubmit:d,children:[e.jsxs(ye,{children:["How much water",e.jsx(we,{type:"text",name:"water",placeholder:"Enter milliliters",autoComplete:"off"})]}),e.jsx(je,{type:"submit",children:"Confirm"})]}),e.jsx(ve,{onClick:s,children:"Cancel"})]})]})},Se=t=>t.water.waterIntake,De=()=>{const[t,s]=p.useState(!1),r=f(Q)||0;f(Se);const d=u(),a=f(Ct)||0;function x(){s(!0)}function h(){s(!1)}function o(l,c){return l-a<0?0:Math.round(l-a)}function n(l,c){return c/l*100>=100?100:Math.round(c/l*100)}function m(){d(it()),setTimeout(()=>{d(v())},100),_.success("WaterIntake has been successfuly reset")}return p.useEffect(()=>{d(v())},[a]),e.jsxs(e.Fragment,{children:[e.jsxs(me,{children:[e.jsx(F,{children:"Water"}),e.jsxs(se,{children:[e.jsxs(xe,{children:[e.jsxs(ge,{children:[n(r,a)," %"]}),e.jsx(he,{height:n(r,a)||0})]}),e.jsxs("div",{children:[e.jsx(fe,{onClick:m,children:e.jsx("use",{href:`${w}#trash`})}),e.jsx(ae,{children:"Water consumption"}),e.jsxs(re,{children:[e.jsxs(de,{children:[a&&a," ",e.jsx(q,{children:"ml"})]}),e.jsxs(ce,{children:["left: ",e.jsx(le,{children:o(r)})," ",e.jsx(q,{children:"ml"})]})]}),e.jsxs(pe,{onClick:x,children:[e.jsx(U,{children:e.jsx("use",{href:`${w}#add`})}),"Add water intake"]})]})]})]}),e.jsx($e,{open:t,close:h})]})},Ce=i.li`
...
`,Ke=()=>{const[t,s]=p.useState([]);return p.useEffect(()=>{pt().then(r=>{s(xt(r))}).catch(r=>console.log(r))},[]),e.jsxs(He,{children:[e.jsx(Ve,{children:"Recommended food"}),e.jsx(_e,{children:t.map(({_id:r,img:d,name:a,amount:x,calories:h})=>e.jsx(ht,{id:r,img:d,name:a,amount:x,calories:h},r))}),e.jsxs(X,{to:"/recommended-food",children:["See more",e.jsx(Je,{})]})]})},ti=()=>{const t=u();return p.useEffect(()=>{t(v(j)),t(H(j)),t(W(j))},[t]),e.jsxs(ne,{children:[e.jsxs("div",{className:"container",children:[e.jsxs(Zt,{children:[e.jsx(te,{children:"Today"}),e.jsx(ee,{to:"/dashboard",children:e.jsxs(ie,{children:["On the way to the goal",e.jsx(Yt,{children:e.jsx("use",{href:`${w}#arrow-right`})})]})})]}),e.jsxs(Ut,{children:[e.jsxs(Xt,{children:[e.jsx(wt,{}),e.jsx(De,{})]}),e.jsx(Qt,{})]})]}),e.jsx("div",{className:"container",children:e.jsxs(oe,{children:[e.jsx(qe,{}),e.jsx(Ke,{})]})})]})};export{ti as default};
