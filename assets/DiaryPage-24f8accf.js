import{s as n,j as t,x as Q,y as X,E as Z,z as R,A as ee,B as te,C as w,P as A,u as V,r as l,l as ne,D as re,G as ie,H as ae,i as Y,N as oe,p as se,a as de,I as ce}from"./index-4c2933a5.js";import{t as K,R as le,s as pe,b as G,c as k,l as N,d as O,a as _}from"./calculateTotalIngridients-b7b14b9d.js";let M=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((a,r)=>(r&=63,r<36?a+=r.toString(36):r<62?a+=(r-26).toString(36).toUpperCase():r>62?a+="-":a+="_",a),"");const he=n.div`
  display: flex;
  row-gap: 12px;
  column-gap: 20px;
  flex-wrap: wrap;
...
`,Te=n.button`
  ...
  padding: 0;
  cursor: pointer;
`,v=({item:e,index:a,img:r})=>{const[p,g]=l.useState(!1),[h,b]=l.useState(!1),u=()=>{g(!p)},s=()=>b(!h),{carbohidrates:m,protein:i,fat:c,dish:f,mealType:x,showButton:o}=e;return console.log(x),t.jsx(t.Fragment,{children:o?t.jsxs(H,{children:[t.jsx(U,{children:a+1}),t.jsx(Te,{onClick:u,children:"+ Record your meal"}),p&&t.jsx(le,{onClose:u,image:r,mealType:x})]}):t.jsxs(H,{children:[t.jsx(U,{children:a+1}),t.jsxs(Le,{children:[t.jsx(Ie,{children:f}),f&&m&&t.jsxs(Fe,{type:"button",onClick:s,children:[t.jsx(Be,{src:ze,alt:"Edit"}),"Edit"]}),t.jsxs(Ee,{children:[t.jsxs(P,{children:[t.jsx("span",{children:"Carb."}),m]}),t.jsxs(Ce,{children:[t.jsx("span",{children:"Prot."}),i]}),t.jsxs(De,{children:[t.jsx("span",{children:"Fat."}),c]})]})]}),h&&t.jsx(J,{onClose:s,mealType:x,item:e})]})})},S=(e,a)=>e.length<=3?[...e,...Array(1).fill({mealType:a,showButton:!0}),...Array(3-e.length).fill({})]:[...e,...Array(1).fill({mealType:a,showButton:!0})],We="/healthy_hub/assets/arrow-left-3924980b.svg",Pe=n.main`
...
`,Ve=()=>{var x;const e=V(),a=se(),r=l.useRef(((x=a.state)==null?void 0:x.from)??"/main"),[p,g]=l.useState([]),[h,b]=l.useState([]),[u,s]=l.useState([]),[m,i]=l.useState([]),c=de(pe);l.useEffect(()=>{(async()=>{try{await e(Y(K))}catch(d){ce.error(d)}})()},[e]),l.useEffect(()=>{c&&(g(c.foodIntake.lunch),b(c.foodIntake.breakfast),s(c.foodIntake.dinner),i(c.foodIntake.snack))},[c]);const f=o=>o.filter(T=>T.dish!==null);return t.jsx(Pe,{children:t.jsxs(Re,{children:[t.jsxs(Ne,{children:[t.jsx(Ae,{to:r.current,children:t.jsx(Ge,{src:We,alt:"arrow right"})}),t.jsx(Oe,{children:"Diary"})]}),t.jsxs(_e,{children:[t.jsxs(z,{children:[t.jsxs(L,{children:[t.jsxs(I,{children:[t.jsx(F,{children:t.jsx(B,{src:G,alt:"Plate"})}),t.jsx(E,{children:"Breakfast"})]}),t.jsx(q,{info:k(h)})]}),t.jsx(C,{children:t.jsx(D,{children:S(f(h),"Breakfast").map((o,d)=>t.jsx(v,{item:o,index:d,img:G},M()))})})]}),t.jsxs(z,{children:[t.jsxs(L,{children:[t.jsxs(I,{children:[t.jsx(F,{children:t.jsx(B,{src:N,alt:"Plate"})}),t.jsx(E,{children:"Lunch"})]}),t.jsx(q,{info:k(p)})]}),t.jsx(C,{children:t.jsx(D,{children:S(p,"Lunch").map((o,d)=>t.jsx(v,{item:o,index:d,img:N},M()))})})]}),t.jsxs(z,{children:[t.jsxs(L,{children:[t.jsxs(I,{children:[t.jsx(F,{children:t.jsx(B,{src:O,alt:"Plate"})}),t.jsx(E,{children:"Dinner"})]}),t.jsx(q,{info:k(u)})]}),t.jsx(C,{children:t.jsx(D,{children:S(u,"Dinner").map((o,d)=>t.jsx(v,{item:o,index:d,img:O},M()))})})]}),t.jsxs(z,{children:[t.jsxs(L,{children:[t.jsxs(I,{children:[t.jsx(F,{children:t.jsx(B,{src:_,alt:"Plate"})}),t.jsx(E,{children:"Snack"})]}),t.jsx(q,{info:k(m)})]}),t.jsx(C,{children:t.jsx(D,{children:S(m,"Snack").map((o,d)=>t.jsx(v,{item:o,index:d,img:_},M()))})})]})]})]})})};export{Ve as default};
