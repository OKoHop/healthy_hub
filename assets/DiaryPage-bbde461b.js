import{s as n,j as t,x as Q,y as X,E as Z,z as R,A as ee,B as te,C as w,P as A,u as V,r as l,l as ne,D as re,G as ie,H as ae,i as Y,N as oe,p as se,a as de,I as ce}from"./index-1ae7d0cd.js";import{t as K,R as le,s as pe,b as N,c as k,l as G,d as O,a as _}from"./calculateTotalIngridients-70807783.js";let M=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((a,r)=>(r&=63,r<36?a+=r.toString(36):r<62?a+=(r-26).toString(36).toUpperCase():r>62?a+="-":a+="_",a),"");const me=n.div`
  display: flex;
  row-gap: 12px;
  column-gap: 20px;
  flex-wrap: wrap;
...
`,q=({info:e})=>{const{carbohidrates:a,protein:r,fat:p}=e;return t.jsxs(me,{children:[t.jsxs(he,{children:["Carbonohidrates: ",t.jsx(W,{children:a})]}),t.jsxs(xe,{children:["Protein: ",t.jsx(W,{children:r})]}),t.jsxs(ue,{children:["Fat: ",t.jsx(W,{children:p})]})]})},ge=n.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,Te=n.button`
  ...
  padding: 0;
  cursor: pointer;
`,v=({item:e,index:a,img:r})=>{const[p,g]=l.useState(!1),[m,b]=l.useState(!1),x=()=>g(!p),s=()=>b(!m),{carbohidrates:h,protein:i,fat:c,dish:f,mealType:u,showButton:o}=e;return t.jsx(t.Fragment,{children:o?t.jsxs(H,{children:[t.jsx(U,{children:a+1}),t.jsx(Te,{onClick:x,children:"+ Record your meal"}),p&&t.jsx(le,{onClose:x,image:r,mealType:u})]}):t.jsxs(H,{children:[t.jsx(U,{children:a+1}),t.jsxs(Le,{children:[t.jsx(Ie,{children:f}),f&&h&&t.jsxs(Fe,{type:"button",onClick:s,children:[t.jsx(Be,{src:ze,alt:"Edit"}),"Edit"]}),t.jsxs(Ee,{children:[t.jsxs(P,{children:[t.jsx("span",{children:"Carb."}),h]}),t.jsxs(Ce,{children:[t.jsx("span",{children:"Prot."}),i]}),t.jsxs(De,{children:[t.jsx("span",{children:"Fat."}),c]})]})]}),m&&t.jsx(J,{onClose:s,mealType:u,item:e})]})})},S=(e,a)=>e.length<=3?[...e,...Array(1).fill({mealType:a,showButton:!0}),...Array(3-e.length).fill({})]:[...e,...Array(1).fill({mealType:a,showButton:!0})],We="/healthy_hub/assets/arrow-left-3924980b.svg",Pe=n.main`
