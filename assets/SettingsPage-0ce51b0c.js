import{I as g,K as w,s as i,e as W,h as j,E as L,j as t,k as B,m as P,o as m,u as R,C as V,a as E,O as U,r as p,q as G,x as b}from"./index-8aeed758.js";g.defaults.baseURL="https://health-en-app.onrender.com";const I=w("auth/updateAvatar",async(e,r)=>{try{const a=await g.patch("/users/avatars",e,{headers:{"Content-Type":"multipart/form-data"}});return console.log("updated avatarUrl: ",a.data,"this log is for checking data from the backend"),a.data}catch(a){return r.rejectWithValue(a.message)}}),D=w("auth/updateUser",async(e,r)=>{try{return(await g.patch("/users/update",e)).data}catch(a){return r.rejectWithValue(a.message)}}),N=i.main`
